...
<body>
    ...
    <p><strong>Número de Orden:</strong> {{ $numero_entrada }}</p>
    ...
    <p><strong>Encargado del Area: </strong> {{ $encargado_area }}</p>
            ...
            <tr>
                ...
                <td>
                    <div class="img-producto">
                        <img src="{{ $rutaImagen }}" class="imagen-producto" alt="Imagen del producto">
                    </div>
                </td>
            </tr>
        </tbody>
